...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>calibration Operation</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getColor <em>Color</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getH_min <em>Hmin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getS_min <em>Smin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getV_min <em>Vmin</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getH_max <em>Hmax</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getS_max <em>Smax</em>}</li>
 *   <li>{@link org.xtext.operations.impl.calibrationOperationImpl#getV_max <em>Vmax</em>}</li>
 * </ul>
 *
 * @generated
 */
public class calibrationOperationImpl extends CommandImpl implements calibrationOperation
{
  /**
   ...
   * @generated
   */
  protected calibrationOperationImpl()
  {
    super();
  }
  ...
  {
    return OperationsPackage.Literals.CALIBRATION_OPERATION;
  }
  ...
  public EList<Color> getColor()
  {
    if (color == null)
    {
      color = new EObjectContainmentEList<Color>(Color.class, this, OperationsPackage.CALIBRATION_OPERATION__COLOR);
    }
    return color;
  }
  ...
  public EList<H_min> getH_min()
  {
    if (h_min == null)
    {
      h_min = new EObjectContainmentEList<H_min>(H_min.class, this, OperationsPackage.CALIBRATION_OPERATION__HMIN);
    }
    return h_min;
  }
  ...
  public EList<S_min> getS_min()
  {
    if (s_min == null)
    {
      s_min = new EObjectContainmentEList<S_min>(S_min.class, this, OperationsPackage.CALIBRATION_OPERATION__SMIN);
    }
    return s_min;
  }
  ...
  public EList<V_min> getV_min()
  {
    if (v_min == null)
    {
      v_min = new EObjectContainmentEList<V_min>(V_min.class, this, OperationsPackage.CALIBRATION_OPERATION__VMIN);
    }
    return v_min;
  }
  ...
  public EList<H_max> getH_max()
  {
    if (h_max == null)
    {
      h_max = new EObjectContainmentEList<H_max>(H_max.class, this, OperationsPackage.CALIBRATION_OPERATION__HMAX);
    }
    return h_max;
  }
  ...
  public EList<S_max> getS_max()
  {
    if (s_max == null)
    {
      s_max = new EObjectContainmentEList<S_max>(S_max.class, this, OperationsPackage.CALIBRATION_OPERATION__SMAX);
    }
    return s_max;
  }
  ...
  public EList<V_max> getV_max()
  {
    if (v_max == null)
    {
      v_max = new EObjectContainmentEList<V_max>(V_max.class, this, OperationsPackage.CALIBRATION_OPERATION__VMAX);
    }
    return v_max;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OperationsPackage.CALIBRATION_OPERATION__COLOR:
        return ((InternalEList<?>)getColor()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__HMIN:
        return ((InternalEList<?>)getH_min()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__SMIN:
        return ((InternalEList<?>)getS_min()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__VMIN:
        return ((InternalEList<?>)getV_min()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__HMAX:
        return ((InternalEList<?>)getH_max()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__SMAX:
        return ((InternalEList<?>)getS_max()).basicRemove(otherEnd, msgs);
      case OperationsPackage.CALIBRATION_OPERATION__VMAX:
