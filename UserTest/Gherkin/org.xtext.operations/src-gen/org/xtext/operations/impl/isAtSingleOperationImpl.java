 ...
 * @generated
 */
public class isAtSingleOperationImpl extends SolutionImpl implements isAtSingleOperation
{
  /**
  ...
  public EList<Servo> getServo()
  {
    if (servo == null)
    {
      servo = new EObjectContainmentEList<Servo>(Servo.class, this, OperationsPackage.IS_AT_SINGLE_OPERATION__SERVO);
    }
    return servo;
  }
  ...
  public EList<Angle> getAngle()
  {
    if (angle == null)
    {
      angle = new EObjectContainmentEList<Angle>(Angle.class, this, OperationsPackage.IS_AT_SINGLE_OPERATION__ANGLE);
    }
    return angle;
  }
