...
import org.xtext.ide.contentassist.antlr.internal.InternalPruebaOperationParser;
import org.xtext.services.PruebaOperationGrammarAccess;

public class PruebaOperationParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(PruebaOperationGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PruebaOperationGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalPruebaOperationParser createParser() {
		InternalPruebaOperationParser result = new InternalPruebaOperationParser(null);
