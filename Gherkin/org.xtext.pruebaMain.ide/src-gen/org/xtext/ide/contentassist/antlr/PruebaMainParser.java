...
import org.xtext.ide.contentassist.antlr.internal.InternalPruebaMainParser;
import org.xtext.services.PruebaMainGrammarAccess;

public class PruebaMainParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(PruebaMainGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PruebaMainGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalPruebaMainParser createParser() {
		InternalPruebaMainParser result = new InternalPruebaMainParser(null);
