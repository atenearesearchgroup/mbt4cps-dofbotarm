...
import org.xtext.ide.contentassist.antlr.internal.InternalInitialParser;
import org.xtext.services.InitialGrammarAccess;

public class InitialParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(InitialGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, InitialGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalInitialParser createParser() {
		InternalInitialParser result = new InternalInitialParser(null);
