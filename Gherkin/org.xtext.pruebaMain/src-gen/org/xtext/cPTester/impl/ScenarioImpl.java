...
public class ScenarioImpl extends MinimalEObjectImpl.Container implements Scenario
{
   ...
   */
  @Override
  public EList<And> getAndGiven()
  {
    if (andGiven == null)
    {
      andGiven = new EObjectContainmentEList<And>(And.class, this, CPTesterPackage.SCENARIO__AND_GIVEN);
    }
    return andGiven;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case CPTesterPackage.SCENARIO__AND_GIVEN:
        getAndGiven().clear();
        getAndGiven().addAll((Collection<? extends And>)newValue);
        return;
      case CPTesterPackage.SCENARIO__WHEN:
