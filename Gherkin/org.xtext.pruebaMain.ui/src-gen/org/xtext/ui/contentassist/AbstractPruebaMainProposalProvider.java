...
/**
 * Represents a generated, default implementation of superclass {@link PruebaOperationProposalProvider}.
 * Methods are dynamically dispatched on the first parameter, i.e., you can override them 
 * with a more concrete subtype. 
 */
public abstract class AbstractPruebaMainProposalProvider extends PruebaOperationProposalProvider {
	...
	public void completeAnd_State(EObject model, Assignment assignment, ContentAssistContext context, ICompletionProposalAcceptor acceptor) {
		completeRuleCall(((RuleCall)assignment.getTerminal()), context, acceptor);
	}
