 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pruebaOperation.Servo#getServo <em>Servo</em>}</li>
 * </ul>
 *
 * @see org.xtext.pruebaOperation.PruebaOperationPackage#getServo()
 * @model
 * @generated
 */
public interface Servo extends EObject
{
   ...
   * @see #setServo(int)
   * @see org.xtext.pruebaOperation.PruebaOperationPackage#getServo_Servo()
   * @model
   * @generated
   */
  int getServo();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pruebaOperation.Servo#getServo <em>Servo</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
