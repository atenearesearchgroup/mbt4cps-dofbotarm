 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pruebaOperation.impl.ConditionsImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.pruebaOperation.impl.ConditionsImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionsImpl extends MinimalEObjectImpl.Container implements Conditions
{
  ...
  {
    return PruebaOperationPackage.Literals.CONDITIONS;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PruebaOperationPackage.CONDITIONS__NAME, oldName, name));
  }
  ...
  public EList<Time> getTime()
  {
    if (time == null)
    {
      time = new EObjectContainmentEList<Time>(Time.class, this, PruebaOperationPackage.CONDITIONS__TIME);
    }
    return time;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PruebaOperationPackage.CONDITIONS__TIME:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PruebaOperationPackage.CONDITIONS__NAME:
        return getName();
      case PruebaOperationPackage.CONDITIONS__TIME:
        return getTime();
    }
