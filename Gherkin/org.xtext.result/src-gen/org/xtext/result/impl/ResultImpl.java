 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.result.impl.ResultImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.result.impl.ResultImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultImpl extends MinimalEObjectImpl.Container implements Result
{
  ...
  public EList<Time> getTime()
  {
    if (time == null)
    {
      time = new EObjectContainmentEList<Time>(Time.class, this, ResultPackage.RESULT__TIME);
    }
    return time;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ResultPackage.RESULT__TIME:
