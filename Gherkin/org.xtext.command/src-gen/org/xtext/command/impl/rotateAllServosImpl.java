 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle1 <em>Angle1</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle2 <em>Angle2</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle3 <em>Angle3</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle4 <em>Angle4</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle5 <em>Angle5</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateAllServosImpl#getAngle6 <em>Angle6</em>}</li>
 * </ul>
 *
 * @generated
 */
public class rotateAllServosImpl extends CommandImpl implements rotateAllServos
{
  ...
  {
    return CommandPackage.Literals.ROTATE_ALL_SERVOS;
  }
  ...
  public EList<Angle> getAngle1()
  {
    if (angle1 == null)
    {
      angle1 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE1);
    }
    return angle1;
  }
  ...
  public EList<Angle> getAngle2()
  {
    if (angle2 == null)
    {
      angle2 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE2);
    }
    return angle2;
  }
  ...
  public EList<Angle> getAngle3()
  {
    if (angle3 == null)
    {
      angle3 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE3);
    }
    return angle3;
  }
  ...
  public EList<Angle> getAngle4()
  {
    if (angle4 == null)
    {
      angle4 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE4);
    }
    return angle4;
  }
  ...
  public EList<Angle> getAngle5()
  {
    if (angle5 == null)
    {
      angle5 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE5);
    }
    return angle5;
  }
  ...
  public EList<Angle> getAngle6()
  {
    if (angle6 == null)
    {
      angle6 = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_ALL_SERVOS__ANGLE6);
    }
    return angle6;
  }
