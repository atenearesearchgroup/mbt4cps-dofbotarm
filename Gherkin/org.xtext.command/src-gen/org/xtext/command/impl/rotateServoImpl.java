 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.command.impl.rotateServoImpl#getServo <em>Servo</em>}</li>
 *   <li>{@link org.xtext.command.impl.rotateServoImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class rotateServoImpl extends CommandImpl implements rotateServo
{
  ...
  {
    return CommandPackage.Literals.ROTATE_SERVO;
  }
  ...
  public EList<Servo> getServo()
  {
    if (servo == null)
    {
      servo = new EObjectContainmentEList<Servo>(Servo.class, this, CommandPackage.ROTATE_SERVO__SERVO);
    }
    return servo;
  }
  ...
  public EList<Angle> getAngle()
  {
    if (angle == null)
    {
      angle = new EObjectContainmentEList<Angle>(Angle.class, this, CommandPackage.ROTATE_SERVO__ANGLE);
    }
    return angle;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CommandPackage.ROTATE_SERVO__SERVO:
        return ((InternalEList<?>)getServo()).basicRemove(otherEnd, msgs);
      case CommandPackage.ROTATE_SERVO__ANGLE:
