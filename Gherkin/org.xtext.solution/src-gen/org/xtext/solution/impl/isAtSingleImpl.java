 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.solution.impl.isAtSingleImpl#getServo <em>Servo</em>}</li>
 *   <li>{@link org.xtext.solution.impl.isAtSingleImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class isAtSingleImpl extends SolutionImpl implements isAtSingle
{
  ...
  {
    return SolutionPackage.Literals.IS_AT_SINGLE;
  }
  ...
  public EList<Servo> getServo()
  {
    if (servo == null)
    {
      servo = new EObjectContainmentEList<Servo>(Servo.class, this, SolutionPackage.IS_AT_SINGLE__SERVO);
    }
    return servo;
  }
  ...
  public EList<Angle> getAngle()
  {
    if (angle == null)
    {
      angle = new EObjectContainmentEList<Angle>(Angle.class, this, SolutionPackage.IS_AT_SINGLE__ANGLE);
    }
    return angle;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SolutionPackage.IS_AT_SINGLE__SERVO:
        return ((InternalEList<?>)getServo()).basicRemove(otherEnd, msgs);
      case SolutionPackage.IS_AT_SINGLE__ANGLE:
