 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.cPTester.impl.SolutionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.cPTester.impl.SolutionImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link org.xtext.cPTester.impl.SolutionImpl#getAngle_res <em>Angle res</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolutionImpl extends MinimalEObjectImpl.Container implements Solution
{
  ...
  {
    return CPTesterPackage.Literals.SOLUTION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CPTesterPackage.SOLUTION__NAME, oldName, name));
  }
  ...
  public EList<Angle> getAngle()
  {
    if (angle == null)
    {
      angle = new EObjectContainmentEList<Angle>(Angle.class, this, CPTesterPackage.SOLUTION__ANGLE);
    }
    return angle;
  }
  ...
  public EList<Angle_res> getAngle_res()
  {
    if (angle_res == null)
    {
      angle_res = new EObjectContainmentEList<Angle_res>(Angle_res.class, this, CPTesterPackage.SOLUTION__ANGLE_RES);
    }
    return angle_res;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPTesterPackage.SOLUTION__ANGLE:
        return ((InternalEList<?>)getAngle()).basicRemove(otherEnd, msgs);
      case CPTesterPackage.SOLUTION__ANGLE_RES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CPTesterPackage.SOLUTION__NAME:
        return getName();
      case CPTesterPackage.SOLUTION__ANGLE:
        return getAngle();
      case CPTesterPackage.SOLUTION__ANGLE_RES:
