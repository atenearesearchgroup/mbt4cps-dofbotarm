 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.cPTester.impl.isAtImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link org.xtext.cPTester.impl.isAtImpl#getAngle_res <em>Angle res</em>}</li>
 * </ul>
 *
 * @generated
 */
public class isAtImpl extends ConditionsImpl implements isAt
{
  /**
  ...
  {
    return CPTesterPackage.Literals.IS_AT;
  }
  ...
  public EList<Angle> getAngle()
  {
    if (angle == null)
    {
      angle = new EObjectContainmentEList<Angle>(Angle.class, this, CPTesterPackage.IS_AT__ANGLE);
    }
    return angle;
  }
  ...
  public EList<Angle_res> getAngle_res()
  {
    if (angle_res == null)
    {
      angle_res = new EObjectContainmentEList<Angle_res>(Angle_res.class, this, CPTesterPackage.IS_AT__ANGLE_RES);
    }
    return angle_res;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CPTesterPackage.IS_AT__ANGLE:
        return ((InternalEList<?>)getAngle()).basicRemove(otherEnd, msgs);
      case CPTesterPackage.IS_AT__ANGLE_RES:
