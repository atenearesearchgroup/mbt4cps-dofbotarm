  ...
  public CharSequence toCode(final Scenario scenario) {
          ...
          for(final Command cmd : _command) {
            _builder.append("\t\t\t\t");
            {
              ...
              if (_equals) {
                ...
                boolean _equals_1 = cmd.eClass().getName().equals("rotateAllServosOperation");
                if (_equals_1) {
                  ...
                  boolean _equals_2 = cmd.eClass().getName().equals("readAllServosOperation");
                  if (_equals_2) {
                    ...
                    boolean _equals_3 = cmd.eClass().getName().equals("readServoOperation");
                    if (_equals_3) {
                      ...
                      boolean _equals_4 = cmd.eClass().getName().equals("cameraColorOperation");
                      if (_equals_4) {
                        ...
                        boolean _equals_5 = cmd.eClass().getName().equals("calibrationOperation");
                        if (_equals_5) {
                          ...
                          boolean _equals_6 = cmd.eClass().getName().equals("buzzerOnOperation");
                          if (_equals_6) {
                            ...
                            boolean _equals_7 = cmd.eClass().getName().equals("buzzerOffOperation");
                            if (_equals_7) {
                              ...
                              boolean _equals_8 = cmd.eClass().getName().equals("lightRGBOperation");
                              if (_equals_8) {
              ...
              for(final Command cmd_1 : _command_1) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_equals_9) {
                    _builder.append("\t\t\t\t");
                    {
                      boolean _equals_10 = cmd_1.getName().equals("rotateServoOperation");
                      if (_equals_10) {
                        ...
                        boolean _equals_11 = cmd_1.getName().equals("rotateAllServosOperation");
                        if (_equals_11) {
    ...
    _builder.append("\t\t\t\t");
    {
      ...
      for(final Command cmd_2 : _command_2) {
        {
          boolean _equals_12 = cmd_2.eClass().getName().equals("rotateServoOperation");
          if (_equals_12) {
            ...
            boolean _equals_13 = cmd_2.eClass().getName().equals("rotateAllServosOperation");
            if (_equals_13) {
              ...
              boolean _equals_14 = cmd_2.eClass().getName().equals("readAllServosOperation");
              if (_equals_14) {
                ...
                boolean _equals_15 = cmd_2.eClass().getName().equals("readServoOperation");
                if (_equals_15) {
                  ...
                  boolean _equals_16 = cmd_2.eClass().getName().equals("cameraColorOperation");
                  if (_equals_16) {
                    ...
                    boolean _equals_17 = cmd_2.eClass().getName().equals("calibrationOperation");
                    if (_equals_17) {
                      ...
                      boolean _equals_18 = cmd_2.eClass().getName().equals("buzzerOnOperation");
                      if (_equals_18) {
                        ...
                        boolean _equals_19 = cmd_2.eClass().getName().equals("buzzerOffOperation");
                        if (_equals_19) {
                          ...
                          boolean _equals_20 = cmd_2.eClass().getName().equals("lightRGBOperation");
                          if (_equals_20) {
      ...
      for(final And and_1 : _and_1) {
        {
          ...
          for(final Solution sol : _solution) {
            _builder.append("\t\t\t\t");
            {
              boolean _equals_21 = sol.eClass().getName().equals("isAtSingleOperation");
              if (_equals_21) {
                ...
                boolean _equals_22 = sol.eClass().getName().equals("isAtOperation");
                if (_equals_22) {
