...
public class OperationsSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 * <pre>
	 * Contexts:
	 *     Operaciones returns Conditions
	 ...
	 * <pre>
	 * Contexts:
	 *     Operaciones returns isAtSingle
	 ...
	 * <pre>
	 * Contexts:
	 *     Operaciones returns rotateAllServos
	 ...
	 * <pre>
	 * Contexts:
	 *     Operaciones returns rotateServo
