...
{
    [Serializable]
    public class Board : MachinePart
    {
...
#region Children and used machineparts
        ...
        {
            PublishChild(ChildId.Light, Light, "Light");
            PublishChild(ChildId.Buzzer, Buzzer, "Buzzer");
        }
...
#region InitPre / InitPost
        protected override void InitPre()
        {
            ...
            if (Buzzer == null) { Buzzer = new Buzzer(); }
        }
...
#region Observers
        ...
        protected override void PublishObservers()
        {
            ...
            obs_MachinePartHash.Value = 911716;
        }
#endregion // Observers
