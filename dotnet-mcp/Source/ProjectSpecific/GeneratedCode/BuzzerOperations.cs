...
{
    [Serializable]
    public class BuzzerOperations : MachinePart
    {
...
#region Enumerations
        ...
        {
            buzzerOnOperationArgaTime = 2100,
        }
...
#region Observers
        ...
        protected override void PublishObservers()
        {
            ...
            obs_MachinePartHash.Value = 548512;
        }
#endregion // Observers
...
#region Commands
        ...
        // Arguments
        public SettingInt buzzerOnOperationArgaTime;
...
#region Public methods
        ...
        public void buzzerOnOperation(int aTime)
        {
            Dofbot dof = new Dofbot();
            dof.buzzerOn(aTime);
        }

        public void buzzerOffOperation()
        {
            Dofbot dof = new Dofbot();
            dof.buzzerOff();
        }
...
#region Cyclic methods
        ...
        /// <summary>
        /// The cyclic method for BuzzerOperations.
        /// </summary>
