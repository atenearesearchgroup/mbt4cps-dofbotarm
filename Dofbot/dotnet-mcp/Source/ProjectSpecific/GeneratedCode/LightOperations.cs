...
{
    [Serializable]
    public class LightOperations : MachinePart
    {
...
#region Enumerations
        ...
        {
            lightRGBOperationArgr = 2100,
            lightRGBOperationArgg = 2101,
            lightRGBOperationArgb = 2102,
        }
...
#region Observers
        ...
        protected override void PublishObservers()
        {
            ...
            obs_MachinePartHash.Value = 160130;
        }
#endregion // Observers
...
#region Commands
        ...
        // Arguments
        public SettingInt lightRGBOperationArgr;
        public SettingInt lightRGBOperationArgg;
        public SettingInt lightRGBOperationArgb;
...
#region Public methods
        ...
        public String lightRGBOperation(int r, int g, int b)
        {
            Dofbot dof = new Dofbot();
            return dof.lightRGB(r,g,b);
        }
...
#region Cyclic methods
        ...
        /// <summary>
        /// The cyclic method for LightOperations.
        /// </summary>
